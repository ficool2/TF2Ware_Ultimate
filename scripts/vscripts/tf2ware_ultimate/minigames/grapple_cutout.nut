...
({
	...
	location        = "boxarena"
	music           = "farm"
	custom_overlay  = cutout == 1 ? "grapple_deer" : "grapple_cow"
})
...
cutout_model <- cutout_models[cutout]
...
function OnStart()
{
	...
	local angles = cutout == 1 ? QAngle(0, 90, 0) : QAngle(0, 0, 0)
